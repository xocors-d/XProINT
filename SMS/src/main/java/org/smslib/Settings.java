...
public class Settings
{
	 ...
	 */
	//Change to 1 Sec: public int SERIAL_KEEPALIVE_INTERVAL = 60;
	//public int SERIAL_KEEPALIVE_INTERVAL = 1;//Change to 1 sec;
	public int SERIAL_KEEPALIVE_INTERVAL = 60;//20150918 resume to 60 to reduce out of index issue.
	 ...
	 */
	//Eric20150324 public boolean MASK_IMSI = true;
	public boolean MASK_IMSI = false;//Eric20150324
	 ...
	 */
	//20160404 public int HOURS_TO_ORPHAN = 48;
	public int HOURS_TO_ORPHAN = 0;//20160404
