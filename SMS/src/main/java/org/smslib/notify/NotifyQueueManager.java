...
public class NotifyQueueManager
{
	...
	public void start()
	{
		//20150731 setNotifyQueueManager(new NotificationQueueManager("NotifyQueueManager", 100));
		setNotifyQueueManager(new NotificationQueueManager("NotifyQueueManager", 50));//20150731
	}
